  ...
  return (
    <div className='p-10 flex flex-col gap-6 justify-center'>
      ...
      <NavLink to=''>
        ...
        <h3 className='text-lg md:text-2xl lg:text-3xl font-bold'>Congress Party</h3>
        <button className="py-2 bg-green-400 hover:bg-green-500 text-white rounded-lg text-lg">Vote</button>
        </div>
      </div>
      ...
      <NavLink to=''>
        ...
        <div className='flex flex-col justify-between'>
        <h3 className='text-lg md:text-2xl lg:text-3xl font-bold'>Bhartia Janta Party</h3>
        <button className="py-2 bg-green-400 hover:bg-green-500 text-white rounded-lg text-lg">Vote</button>
        </div>
      </div>
      ...
      <NavLink to=''>
        ...
        <div className='flex flex-col justify-between'>
        <h3 className='text-lg md:text-2xl lg:text-3xl font-bold'>Aam Aadmi Party</h3>
        <button className="py-2 bg-green-400 hover:bg-green-500 text-white rounded-lg text-lg">Vote</button>
        </div>
      </div>
      ...
      <NavLink to=''>
        ...
        <div className='flex flex-col justify-between'>
        <h3 className='text-lg md:text-2xl lg:text-3xl font-bold'>Bahujan Samaj Party</h3>
        <button className="py-2 bg-green-400 hover:bg-green-500 text-white rounded-lg text-lg">Vote</button>
        </div>
      </div>
      ...
      <NavLink to=''>
        ...
        <div className='flex flex-col justify-between'>
        <h3 className='text-lg md:text-2xl lg:text-3xl font-bold'>National Conference Party</h3>
        <button className="py-2 bg-green-400 hover:bg-green-500 text-white rounded-lg text-lg">Vote</button>
        </div>
      </div>
