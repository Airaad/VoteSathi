  ...
  return (
    ...
    <div className='bg-orange-400 p-20 flex gap-2'>
        ...
        <div className='mt-4'>
            ...
            <p>Each vote is recorded on the decentralized that cannot be altered or erased</p>
        </div>
    </div>
    ...
    <BsTransparency className='text-6xl hover:animate-wiggle'/>
        <div className='mt-4'>
            ...
            <p>All votes are recorded on a public ledger, allowing full visibility in voting process</p>
        </div>
    </div>
    ...
    <TbHandClick className='text-6xl hover:animate-wiggle'/>
        <div className='mt-4'>
            ...
            <p>Votsathi offers an intuitive and accessible interface that ensures a seamless voting experience for all users</p>
        </div>
        </div>
    </div>
  )
