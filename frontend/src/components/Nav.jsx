...
const NavLinks = ()=> {
  return (
    <>
        <NavLink to='/home' className='text-white font-semibold'>Home</NavLink>
        <NavLink to='/about' className='text-white font-semibold'>About</NavLink>
        <Button pill className='bg-green-400  font-bold'>Sign In</Button>
    </>
  )
}
